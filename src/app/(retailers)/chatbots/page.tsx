...
const Chatbotss = () => {
  ...
  return (
<div className="min-h-screen flex dark:bg-muted bg-[#F5F5F5] bg-cover bg-center scrollbar-hidden" style={{ backgroundImage: `url('../../public/96c2e8fda549ae99693e87ffeba899ef.jpg')` }}>
  ...
  {/* This is sidebar */}
  <div className={`fixed w-64 h-screen bg-muted border-r-2 dark:border-white border-black overflow-y-auto z-40 transform ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"} lg:translate-x-0 transition-transform duration-300 ease-in-out`}>
  <div className='p-5 h-full flex flex-col'>
      <div className='flex mb-15'>
        {/* <img src={gptImgLogo} className='w-24 h-24 mx-4' alt="Chatbot Logo" /> */}
        <span className='text-2xl left-1/2 font-bold  mt-2 dark:text-white text-black '>EXE RAG</span>
        </div>
        <Button onClick={handleNewChat} variant="default" className="mb-4 mt-5 text-[##333333] hover:bg-gray-300 dark:text-white  dark:hover:bg-gray-800 sticky bg-white dark:bg-black px-8 py-0.5  border-2 border-black dark:border-black uppercase text-black transition duration-200 text-sm shadow-[1px_1px_rgba(0,0,0),2px_2px_rgba(0,0,0),3px_3px_rgba(0,0,0),4px_4px_rgba(0,0,0),5px_5px_0px_0px_rgba(0,0,0)] dark:shadow-[1px_1px_rgba(255,255,255),2px_2px_rgba(255,255,255),3px_3px_rgba(255,255,255),4px_4px_rgba(255,255,255),5px_5px_0px_0px_rgba(255,255,255)]">
...
<button
  ...
  {/* This is ChatScreen */}
  <div className={`flex-1  flex flex-col dark:bg-muted transition-transform duration-300 ease-in-out ${isSidebarOpen ? "ml-0 blur-md opacity-50 pointer-events-none" : "ml-0"} lg:ml-64 mb-12`}>
  <div className="flex-1  overflow-x-hidden  p-4 ">
  <Image
    src="/exe logo2.png"
    className="absolute left-[34rem] opacity-20 dark:opacity-20" // Adjust opacity for normal and dark mode
    alt="Chatbot avatar"
    width={1000}
    height={1000}
  />
  ...
  <Image
    src="/exe logo.png" // Use a dark version of the image for dark mode
    className="absolute left-[34rem] opacity-20  hidden dark:block" // Hide in light mode, show in dark mode
  ...
  />
      ...
      <>
        {activeSession.messages.map((message, i) => (
          ...
          >
            ...
            <div
              className={`inline-flex ${message.isBot ? "bg-[black] rounded-t-2xl rounded-br-2xl" : "bg-[#F1F1F1] rounded-t-2xl rounded-bl-2xl"} shadow-lg backdrop-blur-md p-3 max-w-[75%]`}
              style={{ 
    ...
    {/* This is input */}
    <div className="fixed z-50 bottom-0 left-[65rem] transform -translate-x-1/2 w-full flex justify-center px-4">
  <div
